...
import {updateMenuStatus, authSetClear} from '../Redux/Actions';
...
class StartScreen extends React.Component {
  ...
  render() {
    ...
    return (
      <SafeAreaView
        style={{...CustomStyles.container, backgroundColor: 'rgb(47,47,47)'}}>
        <Video
...
export default connect(mapStateToProps, {updateMenuStatus, authSetClear})(
  withTheme(StartScreen),
);
