...
import {
  BackHandler, StyleSheet, ActivityIndicator, Text, View, FlatList,
  InteractionManager, Image, Dimensions, TouchableOpacity
...
class DashboardScreen extends React.Component {
  ...
  getErrorMessage() {
    if (this.props.get_address.code !== undefined && this.props.get_address.code !== 200) {

      return this.props.get_address.message
    }
    else if (this.props.all_history.code !== undefined && this.props.all_history.code !== 200) {

      return this.props.all_history.message
    }
    else if (this.props.balance.code !== undefined && this.props.balance.code !== 200) {
