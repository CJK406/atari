...
export const PAYPAL_CLIENT =
  'ARHm04t5sDvIMQXlvT4wXU__A2LGmAITVa7M666dqKnzQSGiGXlKm_X8e18G4HUsuenHmZfmsbj-oSLe';

export const Headers = [
  {
    Image: Images.Atri_icon,
    qr_image: Images.Atri_qr_icon,
    text: 'ATRI',
    color: '#ce2424',
    full_text: 'atri',
    graph_text: 'atari',
  ...
  },
  {
    ...
    qr_image: Images.bnb_qr_icon,
    text: 'BNB',
    color: 'rgb(243,186,46)',
    full_text: 'Binance Coin',
    graph_text: 'binancecoin',
    history_t: 'BNB',
  },
  {
    Image: Images.Ltc_icon,
    qr_image: Images.Ltc_qr_icon,
    text: 'LTC',
    color: '#345c9c',
    full_text: 'litecoin',
    graph_text: 'litecoin',
